...
/**
 * Parent Signup - parent-signup.php
 */
    ...
    if (count($errors) === 0) {
        if (!$pdo) {
            ...
            if ($userModel->emailExists($email)) {
                ...
                if ($userModel->create($email, $password, $name, 'parent')) {
                    $success = 'Parent account created successfully! Redirecting to login...';
...
<head>
    ...
    <title>Parent Sign Up - MindCare</title>
        ...
        <div class="bg-white rounded-[2rem] shadow-xl shadow-emerald-100/50 border border-emerald-100 overflow-hidden">
            <div class="p-8 md:p-10">
                ...
                <div class="flex flex-col items-center text-center mb-10">
                    ...
                    <p class="text-gray-500 mt-2">Join the MindCare community</p>
                </div>
                ...
                <form method="POST" class="space-y-5">
                    <div class="space-y-2">
                        ...
                        <div class="relative group">
                            <i data-lucide="user" class="absolute left-4 top-1/2 -translate-y-1/2 size-5 text-gray-400 group-focus-within:text-emerald-500 transition-colors"></i>
                    ...
                    <div class="space-y-2">
                        ...
                        <p class="text-[10px] text-gray-400 ml-1 italic">At least 8 chars, 1 uppercase, 1 digit</p>
                    </div>

                    <div class="space-y-2">
                        <label class="text-sm font-semibold text-gray-700 ml-1">Confirm Password</label>
                        <div class="relative group">
                            <i data-lucide="shield-check" class="absolute left-4 top-1/2 -translate-y-1/2 size-5 text-gray-400 group-focus-within:text-emerald-500 transition-colors"></i>
                    ...
                    <div class="flex items-start gap-3 px-1 py-2">
                        ...
                        <label class="text-xs text-gray-600 leading-tight">
                            I agree to the <a href="#" class="text-emerald-600 font-bold hover:underline">Terms of Service</a> and
                            <a href="#" class="text-emerald-600 font-bold hover:underline">Privacy Policy</a>
                        </label>
                    </div>
                ...
                <div class="mt-8 text-center text-sm">
                    <p class="text-gray-500">
                        ...
                        <a href="parent-login.php" class="text-emerald-600 font-bold hover:underline ml-1">Login here</a>
                    </p>
                </div>
            </div>
        </div>
